...
mod balances {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn transfer(
            ...
            let to_balance = to_balance.checked_add(&amount).ok_or("Owerflow occured.")?;
            self.set_balance(&caller, from_balance);
...
pub enum RuntimeCall {
    ...
    proof_of_existance(proof_of_existance::Call<Runtime>),
}
impl crate::support::Dispatch for Runtime {
    ...
    fn dispatch(
        ...
        match runtime_call {
            ...
            RuntimeCall::proof_of_existance(call) => {
...
impl Runtime {
    fn new() -> Self {
        Self {
            ...
            proof_of_existance: <proof_of_existance::Pallet<Self>>::new(),
        }
    }
    ...
    let block2 = types::Block {
        ...
        extrinsics: <[_]>::into_vec(
            ...
            ::alloc::boxed::Box::new([
                ...
                support::Extrinsic {
                    caller: alice.clone(),
                    call: RuntimeCall::proof_of_existance(proof_of_existance::Call::revoke_claim {
                        claim: "Hello.",
                    }),
                },
            ]),
